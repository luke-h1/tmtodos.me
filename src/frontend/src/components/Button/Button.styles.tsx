...
export const StyledButton = styled('button', {
  ...
  width: 'max-content',
  padding: '11px 16px',
  transition: 'background 0.2s, transform 0.2s, colors 0.2s, box-shadow 0.3s',
  ...
  '--shadow-hover-primary': '0 2px 40px -4px var(--tmtodos-form-input-focus)',
  ...
  variants: {
    variant: {
      primary: {
        '--background': 'var(--tmtodos-colors-brand)',
        '--color': 'hsl(var(--palette-gray-00))',
        '&:disabled': {
          '--background': 'var(--tmtodos-form-input-disabled)',
      ...
      secondary: {
        '--background': 'var(--tmtodos-color-emphasis)',
        '--color': 'var(--tmtodos-colors-brand)',
        '&:disabled': {
          '--background': 'var(--tmtodos-form-input-disabled)',
          '--color': 'var(--tmtodos-colors-typeface-tertiary)',
        },
...
export const StyledIconButton = styled('button', {
  ...
  borderRadius: 'var(--border-radius-1)',
  color: 'var(--color, var(--tmtodos-colors-typeface-tertiary))',
  ...
  '&::after': {
    ...
    background: 'var(--background, var(--tmtodos-colors-foreground))',
  ...
  '&:hover': {
    '&:not(:disabled)': {
      '--border-color': 'var(--tmtodos-colors-brand)',
